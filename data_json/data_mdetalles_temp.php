...
$unid=$_GET["este"];
	...
	$result = array();
	$data = MdetallesTemp::find_by_sql("select id,cid,d_tipo,d_concepto,d_cantidad,d_medida,d_costo,d_obs,mrequerimientos_id,status,dia from mdetalles_temp WHERE status=1 AND mrequerimientos_id=".$unid." order by id desc;");
	$items = 0;
