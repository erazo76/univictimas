	...
	************************************************************************************************************/
	...
	var arrayOfItemsToSelect2 = new Array();
	...
	function multipleSelectOnSubmit()
	{
		...
		for(var no=0;no<arrayOfItemsToSelect2.length;no++){
			var obj = arrayOfItemsToSelect2[no];
			for(var no2=0;no2<obj.options.length;no2++){
				obj.options[no2].selected = true;
			}
		}		
	...
	{		
		...
		arrayOfItemsToSelect2[arrayOfItemsToSelect2.length] = fromObj;
