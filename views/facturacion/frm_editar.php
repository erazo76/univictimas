...
<div  class="row">
			...
			<div class="col-md-4">
				...
				<h3 class="box-title">Datos de la Solicitud</h3>
				  ...
				  <input type="hidden" id="id_fac" value="<?php echo intval($_GET["id_fac"]); ?>">						
			...
			<div class="box box-primary">
				<div class="box-body">
						...
						<div class="form-group-sm">	
							...
							<input class="form-control bbb" id="gastos_reembolsables"  type="text" placeholder="Valor Gastos reembolsables" onkeypress="return esnumero_gastos_reembolsables(event)" onpaste="return true" onchange="return SumarIntermediacion(value)"  tabindex="16" >
...
$(document).ready(function() {
		$.post( "../../controllers/mfacturados_controller", { action: "search_facturados",id_fac:<?php echo intval($_GET["id_fac"]); ?>}).done(function( data ) {
		...
		$("#servicios_gravados").val(parsedJson.servicios_gravados);
		$("#iva").val(parsedJson.iva);
		$("#ejecutado_logistico").val(parsedJson.ejecutado_logistico);
		$("#gastos_reembolsables").val(parsedJson.gastos_reembolsables);
		$("#giro_fecty").val(parsedJson.giro_fecty);
		$("#intermediacion").val(parsedJson.intermediacion);
		$("#iva_intermediacion_reembolso").val(parsedJson.iva_intermediacion_reembolso);		
		$("#ejecutado_reembolso").val(parsedJson.ejecutado_reembolso);
		$("#costo_tiquetes_ejecutado").val(parsedJson.costo_tiquetes_ejecutado);
...
function SumarEjecutadoLogistico (valor) {

	$("#ejecutado_logistico").val(0);
    var TotalSuma = 0;  
    valor = parseInt(valor); // Convertir a numero entero (número).
    TotalSuma = parseInt($("#costo_evento_cotizado").val())+parseInt($("#servicios_no_gravados").val());   
    TotalSuma = parseInt(TotalSuma);
