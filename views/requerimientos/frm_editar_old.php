			...
			<!-- form start -->
			  <div class="box-body">
				...
				<div class="form-group">
				  ...
				  <input type="password" class="form-control" id="password1" placeholder="Password" tabindex="4">
				</div>
				<div class="form-group">
				  <label for="password2">Confirmar contraseña</label>
				  <input type="password" class="form-control" id="password2" placeholder="Password" tabindex="5">
				</div>
			  </div><!-- /.box-body -->
		  ...
		  <div class="box box-primary">
			...
			<!-- form start -->
			  <div class="box-body">
				...
				<div class="form-group">
					<img class="imgusr" alt="Imagen de usuario" src="">
				</div>

				<div class="form-group">
				  <label for="exampleInputFile">Adjuntar nueva imagen</label>
             		...
             		if(caso2.length < 5){
            			...
            			document.getElementById('ms_nombre').innerHTML = 'Debe escribir al menos 5 caractéres';
                 		...
                 		if(n_palabras >= 2 && n_palabras  <= 4 ){
                 			...
                 			document.getElementById("ms_nombre").innerHTML = 'Ingrese un nombre(s) y apellido(s)';
