		...
		<div class="col-md-6">
		  ...
		  <div class="box box-primary">
			...
			<div class="box-header with-border">
			  <h3 class="box-title">Registrar  grupo, área, equipo o dependencia</h3>
			</div><!-- /.box-header -->
			<!-- form start -->
			  <div class="box-body">
						...
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" id="nombre" placeholder="Ingrese el nombre del grupo, área, equipo o dependencia" onkeypress="return esnombre(event);" onblur="alsalir(this.id)">
				...
				$.post( "../../controllers/grupos_controller", {
					...
					if(parsedJson.resultado != 'alert'){
					      ...
					      setTimeout(function(){
					                  ...
					                  $(location).attr('href','../grupos/frm_registrar');
