			...
			<div class="box-body">
				...
				<div class="form-group-sm row">
                	<label for="fecha1" class="col-sm-8 col-form-label"><spam class="pull-right">Fecha</spam></label>
               		<div class="col-sm-4">
						<input class="form-control bbb pull-right" id="fecha1" data-date-format="dd-mm-yyyy" placeholder="dia-mes-año" type="text" onpaste="return false" disabled="true">
					</div>	
				</div>	
				<br>
				<div class="form-group-sm row">
				...
				<div class="form-group-sm row">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control bbb" id="marca" placeholder="Ingrese la marca"  onpaste="return false" tabindex="2" onkeypress="return esmarca(event);"  onblur="alsalir(this.id)"  autocomplete="off" >
				...
				<div class="form-group-sm row">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control bbb" id="modelo" placeholder="Ingrese el modelo ó color"  onpaste="return false" tabindex="3" onkeypress="return esmodelo(event);"  onblur="alsalir(this.id)"  autocomplete="off" >
				...
				<div class="form-group-sm row">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control bbb" id="cantidad" placeholder="Cantidad inicial de equipos a ingresar"  onpaste="return false" tabindex="4" onkeypress="return escantidad(event);"  onblur="alsalir(this.id)"  autocomplete="off" >
				...
				<div class="form-group-sm row">
					...
					<div class="col-sm-8">
    					<textarea class="form-control ccc" id="descripcion" rows="4" placeholder="Indique las particularidades del equipo"  onpaste="return false" tabindex="5" onkeypress="return esdescri(event);"  onblur="alsalir(this.id);"  autocomplete="off"></textarea>
...
<script type="text/javascript">
	...
	$("#exit" ).click(function() {
		...
		$.confirm({
			title: '¡Esta acción lo llevará al listado de equipos y borrará los datos no registrados!.¿Desea continuar?',
			content:false,
			confirmButton: 'Si',
			cancelButton: 'No',
	...
	function escantidad(e) {
		...
		n = String.fromCharCode(k);
						...
						if(patron.test(n)==''){
							...
							document.getElementById('ms_cantidad').style.display = 'block';
							document.getElementById("ms_cantidad").innerHTML = 'Use solo nuúmeros';
								return patron.test(n);

						}else{

							document.getElementById("ms_cantidad").innerHTML = '';
							return patron.test(n);
