				...
				<div class="form-group-sm">
					...
					<div class="row">
						...
						<div class="col-sm-6">
								...
								<label for="hora1l">Hora Inicio</label>
								<input class="form-control bbb" id="hora1" type="time"  tabindex="16" min="05:00" max="22:00">
...
//alert($('#distribuidora').val());
		...
		$("#rn_nombre1").val(parsedJson.rn_nombre1);
		$("#rn_nombre2").val(parsedJson.rn_nombre2);
		$("#rn_apellido1").val(parsedJson.rn_apellido1);
		$("#rn_apellido2").val(parsedJson.rn_apellido2);
		$("#tele2").val(parsedJson.tele2);
		$("#correo2").val(parsedJson.correo2);
		
		$("#tipo1").val(parsedJson.tipo1);
		$("#entidad").val(parsedJson.entidad);
