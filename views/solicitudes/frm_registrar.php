...
<form id="form" role="form" enctype="multipart/form-data">
	...
	<div class="base">
		...
		<ul>
							...
							<div class="form-group-sm">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_hora1' class="aaa">
											<p></p>
										</div>
									...
									<div class="col-sm-6">
										...
										<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_hora2' class="aaa">
											<p></p>
										</div>
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div id="confirma_telefono2">
								<ul>
									<li id="conf_tel2" style="color:#fff;text-align:center"></li>
								</ul>
							</div>
							...
							<div id="confirma_correo2">
								<ul>
									<li id="conf_cor2" style="color:#fff;text-align:center"></li>
								</ul>
							</div>
				...
				<div class="col-md-4">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_rt_nombre1' class="aaa">
								<p></p>
							</div>
							...
							<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_rt_apellido1' class="aaa">
								<p></p>
							</div>
							...
							<div id="confirma_telefono">
								<ul>
									<li id="conf_tel" style="color:#fff;text-align:center"></li>
								</ul>
							</div>
							...
							<div id="confirma_correo">
								<ul>
									<li id="conf_cor" style="color:#fff;text-align:center"></li>
								</ul>
							</div>
			...
			<li id="dos">
				<!--################################## INFORMACIÓN RELACIONADA CON EL TIPO DE ACTIVIDAD ##################################  -->
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							<div class="form-group-sm">
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_entidad' class="aaa">
									<p></p>
								</div>
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_num_vic' class="aaa">
									<p></p>
								</div>
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_descripcion' class="aaa">
									<p></p>
								</div>
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_recom' class="aaa">
									<p></p>
								</div>
							</div>
						</div><!-- /.box-body -->
				...
				<div class="col-md-4">
					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="box-body dataTables_wrapper form-inline dt-bootstrap" width="100%" style="width: 100%">
								<label for="tabla30">Soportes adjuntos</label>
			...
			<li id="tres">
				<!--################################## DATOS ALOJAMIENTO Y TRANSPORTE ##################################  -->
					...
					<div class="box box-primary">
						<div class="box-body">
							...
							<div class="form-group-sm">
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_nomb_p'>
									<p></p>
								</div>
							</div>
							...
							<div class="form-group-sm">
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_num_doc_p'>
									<p></p>
								</div>
							</div>
							...
							<div id="confirma_telefono5">
								<ul>
									<li id="conf_tel5" style="color:#fff;text-align:center"></li>
								</ul>
							</div>
						...
						<div class="box-body">
							...
							<div id="ta_dido" style="display:none;">
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_r_aereo'>
										<p></p>
									</div>
								</div>
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_a_ida'>
									<p></p>
								</div>
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_a_vuelta'>
									<p></p>
								</div>
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_a_total'>
										<p></p>
									</div>
								</div>
							</div>
							...
							<div id="tm_dido" style="display:none;">
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_r_ida'>
									<p></p>
								</div>
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_r_vuelta'>
									<p></p>
								</div>
								...
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_r_total'>
										<p></p>
									</div>
								</div>
							</div>
							...
							<div id="tu_dido" style="display:none;">
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_u_terrestre'>
										<p></p>
									</div>
								</div>
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_u_ida'>
									<p></p>
								</div>
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_u_vuelta'>
									<p></p>
								</div>
								...
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_u_total'>
										<p></p>
									</div>
								</div>
							</div>
					...
					<div id="a_oculto" style="display: none;">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_n_aloja'>
									<p></p>
								</div>
								...
								<div class="form-group-sm">
									...
									<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_aloja_total'>
										<p></p>
									</div>
								</div>
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										...
										<div class="form-group-sm">
											...
											<div style="background-color:#F39C12;color:#fff;text-align:center" id='ms_num_doc2'>
												<p></p>
											</div>
										</div>
										...
										<div id="confirma_telefono3">
											<ul>
												<li id="conf_tel3" style="color:#fff;text-align:center"></li>
											</ul>
										</div>
										...
										<div id="confirma_correo3">
											<ul>
												<li id="conf_cor3" style="color:#fff;text-align:center"></li>
											</ul>
										</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		switch (desh) {
			...
			case 1:
				document.getElementById("a_terr").disabled = false;
				document.getElementById("a_terro").disabled = false;
				document.getElementById("a_naci").disabled = false;
				document.getElementById("a_nacio").disabled = false;
				document.getElementById("a_func").disabled = false;
				document.getElementById("a_funco").disabled = false;
				document.getElementById("a_supe").disabled = false;
				document.getElementById("a_supeo").disabled = false;
				break;
			case 2:
				document.getElementById("a_terr").disabled = false;
				document.getElementById("a_terro").disabled = false;
				document.getElementById("a_naci").disabled = true;
				document.getElementById("a_nacio").disabled = false;
				document.getElementById("a_func").disabled = true;
				document.getElementById("a_funco").disabled = false;
...
$.post( "../../controllers/mtarifas_controller", { action: "get_categoria_2"}).done(function( data ) {
	...
	$("#derecha").click(function() {
		...
		if (tick == 0) {
			...
			var cont_alert = $('.bbb').filter(function() {
				return $(this).val() == "";
			}).size();
			...
			var cont_alert3 = $('.ccc').filter(function() {
				return $(this).val() == "";
			}).size();
			//var cont_alert = $('.aaa p:contains("") ').size();
	...
	$('#guardia1').on('focus', function() {
		$('#pertenencia').focus();
		var cont_alert2 = $('.bbb').filter(function() {
			return $(this).val() == "";
		}).size();
		//var cont_alert = $('.aaa p:contains("") ').size();
		//alert(cont_alert2);
	...
	$('#guardia2').on('focus', function() {
		$('#entidad').focus();
		var cont_alert4 = $('.ccc').filter(function() {
			return $(this).val() == "";
		}).size();
		//var cont_alert = $('.aaa p:contains("") ').size();
	...
	$.post("../../controllers/mterritorios_controller", {
		action: "get_gterritorios",
		distribuidoras: $("#distribuidora").val()
	}).done(function(data) {
		$("#territorio").html(data);

	});

	$.post("../../controllers/grupos_controller", {
		action: "get_marcas"
	}).done(function(data) {
		$("#grupo").html(data);
	...
	function esnumero(e) {
		...
		if (patron.test(n) == '') {
			...
			document.getElementById('total_ejecutado').style.display = 'block';
			document.getElementById("total_ejecutado").innerHTML = 'Use solo números';
			return patron.test(n);

		} else {

			document.getElementById("total_ejecutado").innerHTML = '';
			return patron.test(n);
